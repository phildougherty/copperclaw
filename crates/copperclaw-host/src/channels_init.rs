...
use copperclaw_channels_cli::CliFactory;
use copperclaw_channels_core::{
    AdapterError, ChannelAdapter, ChannelFactory, ChannelRegistry, ChannelSetup,
};
use copperclaw_types::{ChannelType, InboundEvent};
...
pub fn build_registry() -> ChannelRegistry {
    ...
    let registrations: &[(&str, RegisterFn)] = &[
        ("cli", copperclaw_channels_cli::register),
        ("telegram", copperclaw_channels_telegram::register),
        ("slack", copperclaw_channels_slack::register),
        ("discord", copperclaw_channels_discord::register),
        ("resend", copperclaw_channels_resend::register),
        ("github", copperclaw_channels_github::register),
        ("linear", copperclaw_channels_linear::register),
        ("webex", copperclaw_channels_webex::register),
        ("matrix", copperclaw_channels_matrix::register),
        ("teams", copperclaw_channels_teams::register),
        ("mattermost", copperclaw_channels_mattermost::register),
        ("line", copperclaw_channels_line::register),
        ...
        ("emacs", copperclaw_channels_emacs::register),
        ("x", copperclaw_channels_x::register),
    ];
