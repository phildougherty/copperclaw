...
//!
//! See `PLAN.md` § 6 (T3). This crate is consumed by `copperclaw-host`; it
...
pub use checks::integrity::{INTEGRITY_ROTATION_SLOTS, IntegrityFinding, QUARANTINE_SIDECAR_NAME};
