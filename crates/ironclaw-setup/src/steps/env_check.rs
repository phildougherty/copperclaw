...
//!
//! Probes `PATH` for the toolchain ironclaw expects: a container runtime
//! (`docker` or `container`), `git`, optionally `gh`, and the `iclaw` CLI.
