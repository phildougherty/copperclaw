...
//!
//! Implements the Slack channel for copperclaw, see `PLAN.md` § 6 (T6).
//!
//! The crate exposes:
//! - [`SlackFactory`] — registers with [`copperclaw_channels_core::ChannelRegistry`].
//! - [`SlackAdapter`] — implements [`copperclaw_channels_core::ChannelAdapter`].
...
//! [`OutboundMessage::content`]: copperclaw_types::OutboundMessage
