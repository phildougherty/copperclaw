...
//!
//! Implements the Teams channel for copperclaw, see `PLAN.md` § 6 (T6).
//!
//! The crate exposes:
//! - [`TeamsFactory`] — registers with [`copperclaw_channels_core::ChannelRegistry`].
//! - [`TeamsAdapter`] — implements [`copperclaw_channels_core::ChannelAdapter`].
...
//!
//! [`copperclaw_types::MessageKind::System`] messages with
...
//! returns [`copperclaw_channels_core::AdapterError::Unsupported`].
//!
...
//! non-empty [`copperclaw_types::OutboundMessage::files`] returns
...
//!    HTML, and emits an [`copperclaw_types::InboundEvent`]. Optional HMAC
...
//! [`copperclaw_channels_core::AdapterError`] variants:
//!
...
pub use api::{
    ChatInfoResponse, ChatMessageResponse, TeamsApi, build_adaptive_breadcrumb,
    build_adaptive_card, build_adaptive_collapsible, build_adaptive_diff, build_adaptive_error,
    build_adaptive_message_body, build_adaptive_thinking, build_adaptive_todo_list,
};
pub use config::{
