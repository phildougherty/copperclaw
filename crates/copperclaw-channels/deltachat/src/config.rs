...
/// limit are surfaced as [`copperclaw_types::MessageKind::System`] with a
...
pub struct DeltaChatConfig {
    ...
    /// [`copperclaw_types::MessageKind::Chat`] events with their bytes
    ...
    /// [`copperclaw_types::MessageKind::System`] with a `reason: "too_large"`.
