...
//!   `IncomingMsg` events into [`InboundEvent`](copperclaw_types::InboundEvent)s.
...
//! event is surfaced as [`MessageKind::Chat`](copperclaw_types::MessageKind::Chat)
...
//!   are surfaced as [`MessageKind::System`](copperclaw_types::MessageKind::System)
