...
//!
//! Hidden behind `IRONCLAW_TODO_NOTIFICATIONS=1` (default off — too
...
use ironclaw_types::{MessageKind, OutboundMessage, SessionId};
...
/// testing.
pub const ENABLE_ENV_VAR: &str = "IRONCLAW_TODO_NOTIFICATIONS";
...
fn session_todos_path(
    data_root: &Path,
    ag: ironclaw_types::AgentGroupId,
    sess: SessionId,
) -> PathBuf {
    data_root
        .join("sessions")
