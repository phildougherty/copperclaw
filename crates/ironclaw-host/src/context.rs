//! Host implementation of [`ironclaw_modules::ModuleContext`].
//!
...
use ironclaw_host_router::{HookChain, Router};
...
mod tests {
    ...
    use ironclaw_host_delivery::FsSessionRoot as DelivFsSessionRoot;
    use ironclaw_host_router::{FsSessionRoot as RouterFsSessionRoot, Router, SessionRoot};
    use ironclaw_modules::context::{
    ...
    fn delivery_service() -> (Arc<DeliveryService>, tempfile::TempDir) {
        ...
        let root: Arc<dyn ironclaw_host_delivery::SessionRoot> =
