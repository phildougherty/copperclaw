...
use ironclaw_host_delivery as delivery;
use ironclaw_host_router as router;
use ironclaw_host_sweep as sweep;
...
impl delivery::SessionRoot for FsSessionRoot {
    fn outbound_pool(
        ...
        paths
            .ensure_dirs()
            .map_err(|e| delivery::DeliveryError::Db(ironclaw_db::DbError::Io(e)))?;
...
mod tests {
    use super::*;
    use ironclaw_host_router::SessionRoot as _;
