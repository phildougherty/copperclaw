...
//! "stripe/invoices"` — that lets users wire one ironclaw install to
//! many sources by namespacing the URL.
//!
//! The body MUST be JSON: ironclaw is structured-message-first, and
...
use axum::Router;
use chrono::Utc;
use ironclaw_types::{ChannelType, InboundEvent, InboundMessage, MessageKind};
