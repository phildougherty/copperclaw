...
//! # Errors
//!
//! - HTTP 401 / 403 → [`ironclaw_channels_core::AdapterError::Auth`].
//! - HTTP 400 / 404 / 422 →
//!   [`ironclaw_channels_core::AdapterError::BadRequest`].
//! - HTTP 429 → [`ironclaw_channels_core::AdapterError::Rate`].
//! - HTTP 5xx / network errors →
//!   [`ironclaw_channels_core::AdapterError::Transport`].
