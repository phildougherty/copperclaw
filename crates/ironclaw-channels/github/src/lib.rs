...
//!
//! Implements the GitHub channel for ironclaw, see `PLAN.md` § 6 (T6).
//!
//! The crate exposes:
//! - [`GithubFactory`] — registers with [`ironclaw_channels_core::ChannelRegistry`].
...
//! # Egress
//!
//! `deliver` translates [`ironclaw_types::OutboundMessage`] into one of three
