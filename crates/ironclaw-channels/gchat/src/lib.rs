...
//!
//! Implements the Google Chat channel for ironclaw, see `PLAN.md` § 6 (T6).
//!
//! The crate exposes:
//! - [`GchatFactory`] — registers with [`ironclaw_channels_core::ChannelRegistry`].
...
//!
//! - `MESSAGE` — produces an [`ironclaw_types::InboundEvent`] of
