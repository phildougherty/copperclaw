...
//!
//! Implements the Resend channel for ironclaw. The crate exposes:
//!
//! - [`ResendFactory`] — registers with [`ironclaw_channels_core::ChannelRegistry`].
...
//! [`ChannelAdapter::supports_threads`]: ironclaw_channels_core::ChannelAdapter::supports_threads
