...
//!
//! Implements the `WhatsApp` Cloud channel for ironclaw, see `PLAN.md` § 6.
//!
//! # Token model
//!
...
//! `messages[]` entry is mapped into an [`ironclaw_types::InboundEvent`].
...
//! - System action `edit` → [`ironclaw_channels_core::AdapterError::Unsupported`]
