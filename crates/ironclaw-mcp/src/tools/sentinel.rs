...
//!   `IRONCLAW_SENTINEL_DIR`, with a process-global test override),
...
const SENTINEL_DIR_ENV_OVERRIDE: &str = "IRONCLAW_SENTINEL_DIR";
...
/// Operators can override via `IRONCLAW_SENTINEL_DIR`. Tests install a
