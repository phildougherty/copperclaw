...
The Claude turn streams a single text block of 2402 chars,
which exceeds the `discord` adapter's 2000-char `max_message_chars`
cap. The splitter cuts on the paragraph (`\n\n`) boundary, yielding
two chunks of 1200 chars each. The fixture asserts:
