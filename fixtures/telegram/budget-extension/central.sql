-- Replay fixture seed: telegram/budget-extension (M22 Wave 0).
--
...
--
-- Four scripted shell turns (each a successful, non-read-only tool
-- call, i.e. real progress) against a soft cap of 2 and a hard ceiling
-- of 8: two full soft-cap blocks complete and the smart auto-continue
-- budget extends silently both times, then the fifth turn's final text
-- ends the run. The streams pin today's silence at each extension.
