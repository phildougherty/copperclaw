-- Replay fixture seed: cli/post-edit-digest (M22 CX — Wave-1 coding X-rider).
--
...
-- `shared`. The fixture drives a single coding turn whose write_file mutation
-- fires the C1 post-edit verify hook.
