-- Replay fixture seed: cli/prototype-verify-gate (M18 X2 — closes the R3
-- verify-gate leg X1 shipped without).
--
-- Identical wiring to fixtures/cli/prototype-golden: one agent group bound to
-- the cli/stdin messaging group, engage pattern `.*`, session mode `shared`.
