-- Replay fixture seed: cli/prototype-self-review-gate (M20 Q6 — the
-- enforced self-review gate before final delivery).
--
-- Identical wiring to fixtures/cli/prototype-verify-gate(-multistage): one
-- agent group bound to the cli/stdin messaging group, engage pattern `.*`,
-- session mode `shared`.
