-- Replay fixture seed: cli/prototype-verify-gate-multistage (M20 X-rider
-- Wave 1 — the Q2 multi-stage verify-gate leg, sibling to M18 X2's
-- cli/prototype-verify-gate which pins the pre-Q2 single-command gate).
--
-- Identical wiring to fixtures/cli/prototype-verify-gate: one agent group
-- bound to the cli/stdin messaging group, engage pattern `.*`, session mode
-- `shared`.
