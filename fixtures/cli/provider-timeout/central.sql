-- Replay fixture seed: cli/provider-timeout.
--
-- Topology identical to cli/text-reply so the only diff vs the baseline
-- is the provider's never-responding behaviour.
