-- Replay fixture seed: cli/operator-alert-delivery.
--
...
-- The baseline turn creates the one Active session O4's OperatorAlerts
-- picks as the carrier for the enqueued alert row.
