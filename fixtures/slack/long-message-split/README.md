...
The Claude turn streams a single text block of 50002 chars,
which exceeds the `slack` adapter's 40000-char `max_message_chars`
cap. The splitter cuts on the paragraph (`\n\n`) boundary, yielding
two chunks of 25000 chars each. The fixture asserts:
